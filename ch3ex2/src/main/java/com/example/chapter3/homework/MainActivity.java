...
public class MainActivity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        AnimatorSet animatorsize=new AnimatorSet();
        ObjectAnimator animatorsize1=ObjectAnimator.ofFloat(target,"scaleX",1.0f, 2.0f,1.0f);
        ObjectAnimator animatorsize2=ObjectAnimator.ofFloat(target,"scaleY",1.0f, 2.0f,1.0f);
        animatorsize.playTogether(animatorsize1,animatorsize2);
        animatorsize.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animatorsize.start();

        // TODO 2：在这里实现另一个 ObjectAnimator，对 target 控件的透明度进行修改，从 1 到 0.5f 循环
        ObjectAnimator animator3=ObjectAnimator.ofFloat(target, "alpha", 1.0f, 0.5f, 1.0F);
        ...
        animatorSet.playTogether(animator1,animatorsize,animator3);
        animatorSet.start();
    }
}
